...
const ko: MessagesRoot = {
  ...
  guide: {
    ...
    intro:
      '업로드부터 설치까지 — 파비콘 패키지 생성의 모든 단계를 안내합니다.',
    stepsH: '사용 단계',
    step1Bold: '사진 업로드',
    step1Body:
      '사진을 드래그 앤 드롭하거나 사진 선택 버튼을 클릭하세요. 지원 형식: PNG, JPEG, WebP (최대 10 MB).',
    step2Bold: '미리보기 및 크롭 확인',
    step2Body:
      '정사각형 크롭 미리보기를 확인하세요. 일부 배포 환경에서는 스타일링된 아바타 미리보기가 표시될 수 있습니다.',
    step3Bold: '파비콘 생성',
    step3Body:
      '미리보기가 마음에 들면 Generate Favicons 버튼을 클릭하세요. 모든 리사이징과 패키징은 브라우저에서 처리되며, 이미지가 서버로 전송되지 않습니다.',
    step4Bold: 'ZIP 다운로드',
    step4Body:
      '패키지를 다운로드한 후, 사이트의 퍼블릭 루트 디렉터리(또는 HTML에서 참조하는 경로)에 압축을 풀어 주세요.',
    step5Bold: '<head>에 태그 추가',
    step5Body:
      '아래 코드를 페이지의 <head>에 붙여 넣으세요. 파일을 서브디렉터리에 둔 경우 href 경로를 수정해 주세요.',
    zipH: 'ZIP 파일 구성',
    zipColFile: '파일',
    zipColDesc: '설명',
    zipDescIco:
      '다중 사이즈 ICO (16×16, 32×32, 48×48) — 레거시 브라우저 대응',
    zipDesc16: '기본 탭 아이콘',
    zipDesc32: '고해상도 탭 아이콘',
    zipDescApple: '180×180 — iOS 홈 화면',
    zipDescAndroid192: '안드로이드 홈 화면',
    zipDescAndroid512: 'PWA 스플래시 화면',
    zipDescManifest: '대형 아이콘을 참조하는 웹 앱 매니페스트',
    tipsH: '좋은 결과를 위한 팁',
    tip1: '얼굴이 중앙에 오는 선명하고 밝은 사진을 사용하세요.',
    tip2:
      '소형 아이콘의 선명도를 높이려면 원본 이미지 해상도가 512×512 px 이상이면 좋습니다.',
    tip3:
      '정사각형 크롭 후에도 중요한 부분이 중앙 안쪽에 들어오도록 구도를 잡으세요.',
    faqH: '자주 묻는 질문',
    faq1H: '어떤 이미지 형식을 업로드할 수 있나요?',
    faq1P:
      'PNG, JPEG, WebP를 지원합니다. SVG는 지원되지 않으므로, 벡터 파일은 미리 래스터화해 주세요.',
    faq2H: '파일은 어디에 두어야 하나요?',
    faq2P:
      '기본적으로 사이트 루트 디렉터리에 두세요. 서브 경로를 사용하는 경우 각 href를 해당 경로로 수정하세요.',
    faq3H: '무료인가요?',
    faq3PBefore: '네, 본인 이미지로 패키지를 생성하는 것은 무료입니다. ',
    faq3PAfter: '을 확인해 주세요.',
    faq4H: '사진이 서버에 저장되나요?',
    faq4PBefore:
      '아니요. 파비콘 리사이징과 ZIP 생성은 모두 브라우저에서 처리됩니다. 아바타 스타일링 관련 사항은 ',
    faq4PMid: '을 참고하세요.',
    termsLink: '이용약관',
    privacyLink: '개인정보처리방침',
    cta: '→ 지금 파비콘 만들기',
