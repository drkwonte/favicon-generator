...
import developersCreatorsPersonalFaviconEn from './bodies/en/developers-creators-personal-favicon.md?raw'
...
import firstImpressionFaviconKo from './bodies/ko/first-impression-favicon.md?raw'
